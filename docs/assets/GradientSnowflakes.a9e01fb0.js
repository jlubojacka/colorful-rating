...
\r
const snowflakes = ref(10);\r
const snowflakeGradient = {\r
  startLightness: 30,\r
  endLightness: 70\r
};\r
<\/script>\r
\r
<style scoped>\r
.snowflake-rating :deep(.rate__button--hoverable){\r
  transition: rotate 0.5s ease;\r
}\r
.snowflake-rating :deep(.rate__button--hoverable):hover  {\r
  rotate: 45deg;\r
}\r
</style>\r
`;export{l as default};
