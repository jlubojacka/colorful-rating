<template>
  <ColorfulRating :length="10" v-model="snowflakes" :gradient="snowflakeGradient" class="snowflake-rating">
...
const snowflakes = ref(10);
const snowflakeGradient = {
  startLightness: 30,
  endLightness: 70
};
</script>
...
<style scoped>
.snowflake-rating :deep(.rate__button--hoverable){
  transition: rotate 0.5s ease;
}
.snowflake-rating :deep(.rate__button--hoverable):hover  {
  rotate: 45deg;
}
</style>
