<template>
  <div>
    <ColorfulRating class="heart-rating" v-model="rating">
    ...
    <button class="reset-button" @click="resetValue" type="button">Reset</button>
  </div>
</template>
